              ...
              Align(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      Image.network(
                        'https://vidabytes.com/wp-content/uploads/2021/03/telmex-tel%C3%A9fono-atenci%C3%B3n-a-clientes-1.jpg',
                        width: 400,
                        height: 230,
                        fit: BoxFit.cover,
                      ),
                      ...
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(10, 5, 10, 5),
                        child: FlutterFlowRadioButton(
                          options: ['Problemas técnicos.'].toList(),
                          onChanged: (value) {
                      ...
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(10, 5, 10, 5),
                        child: FlutterFlowRadioButton(
                          options: ['Problemas con la instalación.'].toList(),
                          onChanged: (value) {
